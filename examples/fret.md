...
|      | Left -> Right matrix     | Right -> Left matrix |
| :------------- | :------------- | : ------ |
| m00       | 0.986       | 1.014 |
| m01       | 0           | 0     |
| m02       | 268.639     | -272.404|
...
#### <a name="3"></a> Localization and Intensity
...
- Add alinea describing the general analysis procedure that will be applied
(Peak finder, ROI transform, Molecule Integrator)
...
| Parameter names  | Iaemaex, Idemdex & Iaemdex  | Iaemaex, Idemdex & Iaemdex  |  Iaemdex & Idemdex |
| Analysis procedure  | Find peaks in red, Transform ROIs (L->R) to colocalize, Molecule integrator (C=0, 1)  | Find peaks in red, Transform ROIs (L->R) to filter out colocalizing peaks, Molecule integrator (C=0, 1)  | Find peaks in green, Transform ROIs (R->L) to filter out colocalizing peaks, Molecule integrator (C=1)  |
