...
If the Molecule Archive of interest is not already opened, import the archive. In case the previous tutorials were not followed visit the [git tutorials repository](https://github.com/duderstadt-lab/mars-tutorials) for an example dataset.
